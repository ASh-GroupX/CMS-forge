...
import EmployeeTodayPage from '../apps/web/src/app/(staff)/tasks/today/page.tsx'; import TaskBoardPage from '../apps/web/src/app/(staff)/tasks/board/page.tsx'; import ComplaintBoardPage from '../apps/web/src/app/(staff)/complaints/board/page.tsx';
...
async function routePage(testCase) {
  ...
  if (testCase.route === 'staff-manager-detail') return staffFrame(testCase, await ManagerTaskDetailPage({
    ...staffProps,
    params: Promise.resolve({ id: 'task_manager_proof' }),
  }));
    ...
    if (testCase.route === 'staff-board') return staffFrame(testCase, await TaskBoardPage(staffProps)); if (testCase.route === 'staff-complaint-board') return staffFrame(testCase, await ComplaintBoardPage(staffProps));
