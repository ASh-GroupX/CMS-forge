...
const allowedSuites = new Set(['auth', 'audit', 'admin', 'security', 'workflow', 'complaints', 'search', 'sla', 'notifications', 'portal', 'portal.tracking', 'attachments', 'integrations', 'surveys', 'reports', 'tasks', 'deals', 'cases']);
