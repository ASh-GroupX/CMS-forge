...
const allowedSuites = new Set(['auth', 'audit', 'admin', 'security', 'workflow', 'search', 'sla', 'notifications', 'portal', 'portal.tracking', 'attachments', 'integrations', 'surveys', 'reports']);
