...
function buildAccessibilityCases() {
  ...
  return [
    ...
    accessibilityCase('workflow dialog', 'ar', { ...arBase, workflow: 'validation' }, [complaintDetailText.ar.sections.workflow, complaintDetailText.ar.workflow.noExtraFields], { route: 'staff-complaint-detail', dialog: complaintDetailText.ar.sections.workflow, minButtons: 8, minLabels: 0 }),
