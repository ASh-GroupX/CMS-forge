...
import type { PortalAttachmentDto, PortalFollowUpResult, PortalOtpRequestResult, PortalSessionResult, PortalTrackingResult } from '../portal.service.js';

export type PortalComplaintResponseDto = {
  complaint: ComplaintCreationResult & { attachments?: PortalAttachmentDto[] };
};
