...
import { saveBranchAction, saveCategoryAction, saveDepartmentAction } from '../actions';
...
export default async function AdminBranchesPage({
  ...
  return (
    <AdminMasterDataOverview
      branchAction={saveBranchAction}
      categoryAction={saveCategoryAction}
      departmentAction={saveDepartmentAction}
