...
export default async function AdminNotificationTemplatesPage({ searchParams }: { searchParams?: Promise<SearchParams> }) {
  const params = await searchParams;
  return (
    <AdminNotificationTemplates locale={resolveLocale(readParam(params?.locale))} state={resolveState(readParam(params?.admin))} />
  );
}
