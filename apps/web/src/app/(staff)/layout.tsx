...
const ROLE_NAV: Record<string, readonly StaffNavKey[]> = {
  ADMIN: ['today', 'board', 'sent', 'promises', 'handoff', 'queue', 'reports', 'manager', 'dashboard', 'create', 'admin', 'audit', 'notifications', 'groups'],
  CR_MANAGER: ['today', 'board', 'sent', 'promises', 'handoff', 'queue', 'reports', 'manager', 'dashboard', 'audit', 'notifications', 'groups'],
  BRANCH_MANAGER: ['today', 'board', 'sent', 'promises', 'handoff', 'queue', 'reports', 'manager', 'dashboard', 'audit', 'notifications', 'groups'],
  MGMT_READONLY: ['board', 'promises', 'handoff', 'queue', 'reports', 'manager', 'dashboard', 'audit', 'notifications', 'groups'],
};

const STAFF_NAV: readonly StaffNavKey[] = ['today', 'board', 'sent', 'promises', 'handoff', 'queue', 'reports', 'dashboard', 'create', 'notifications', 'groups'];
