...
function tasks(count: number): StaffTask[] { return Array.from({ length: count }, (_, index) => ({ id: `visual-task-${count}-${index}`, title: 'Visual task', ownerId: 'visual-owner', ownerName: null, assigneeId: 'visual-user', assigneeName: null, assignedDepartmentId: null, assignedDepartmentName: null, assignedDepartmentNameAr: null, branchId: 'visual-branch', branchName: null, displayTimeZone: 'Africa/Cairo', dueAt: '2026-06-20T09:00:00.000Z', status: 'OPEN', nextAction: null, isCustomerPromise: false, visibility: 'INTERNAL', confidentialityLevel: 'NORMAL', links: [], participantUserIds: [], createdAt: '2026-06-20T09:00:00.000Z', updatedAt: '2026-06-20T09:00:00.000Z' })); }
