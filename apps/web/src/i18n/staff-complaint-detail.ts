...
export const complaintDetailText: Record<Locale, typeof enComplaintDetailText> = {
  ...
  ar: {
    ...
    workflow: {
      ...
      submit: 'إرسال الإجراء',
      actions: ['موافقة', 'إرجاع', 'إسناد', 'تحقيق', 'حل', 'إغلاق', 'رفض', 'إعادة فتح'],
      actionLabels: { SUBMIT: 'إرسال', ACCEPT_INTAKE: 'موافقة', APPROVE_AND_ROUTE: 'موافقة وتوجيه', SEND_BACK: 'إرجاع', ASSIGN_INVESTIGATION: 'إسناد التحقيق', ADD_INVESTIGATION_UPDATE: 'تحقيق', RESOLVE: 'حل', RESOLVE_DIRECTLY: 'حل مباشر', CLOSE: 'إغلاق', REJECT_AS_INVALID: 'رفض', REJECT_AFTER_REVIEW: 'رفض', REJECT_AFTER_INVESTIGATION: 'رفض', REJECT_RESOLUTION: 'رفض الحل', REOPEN: 'إعادة فتح', ROUTE_AGAIN: 'توجيه مرة أخرى' },
...
const enComplaintDetailText = {
  ...
  workflow: {
    ...
    actions: [''],
    actionLabels: {},
    fields: { reason: '', targetBranchId: '', targetDepartmentId: '', ownerId: '', resolutionType: '', resolutionSummary: '', customerCommunicationStatus: '', vehicleDataUnavailableReason: '' },
