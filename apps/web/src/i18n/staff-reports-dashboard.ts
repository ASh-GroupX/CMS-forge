...
export const reportsDashboardText: Record<Locale, typeof enReportsDashboardText> = {
  en: {
    ...
    catalog: { title: 'Report delivery matrix', deferredTitle: 'Deferred reports' },
    operationalRows: {
    ...
    export: {
      ...
      permissionDenied: 'Export requires the report export permission.',
    ...
    states: {
      ...
      denied: 'You do not have permission to view these reports.',
  ...
  ar: {
    ...
    catalog: { title: 'مصفوفة تسليم التقارير', deferredTitle: '\u0627\u0644\u062a\u0642\u0627\u0631\u064a\u0631 \u0627\u0644\u0645\u0624\u062c\u0644\u0629' },
    operationalRows: {
    ...
    export: {
      ...
      csv: 'تحميل CSV',
      excel: 'تحميل Excel',
      permissionDenied: 'يتطلب التصدير صلاحية تصدير التقارير.',
    ...
    states: {
      ...
      denied: 'ليست لديك صلاحية لعرض هذه التقارير.',
