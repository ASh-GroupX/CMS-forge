...
export const portalSubmissionText = {
  en: {
    ...
    next: { title: 'What happens next?', items: ['Staff review the complaint details.', 'Keep the reference number to track updates.', 'Use Track complaint to check the public status.'] },
    actions: {
      copied: 'Reference copied',
      copyReference: 'Copy reference',
      retryOptions: 'Retry loading options',
      submit: 'Submit complaint',
      submitAnother: 'Submit another complaint',
      submitManualReview: 'Submit for manual review',
    ...
    states: {
      ...
      options: 'We could not load the list choices. You can still submit. Staff will classify it.',
  ...
  ar: {
    ...
    next: { title: 'ماذا يحدث بعد ذلك؟', items: ['يراجع الموظفون تفاصيل الشكوى.', 'احتفظ برقم المرجع لمتابعة التحديثات.', 'استخدم متابعة الشكوى لمعرفة الحالة العامة.'] },
    actions: {
      copied: 'تم نسخ رقم المرجع',
      copyReference: 'نسخ رقم المرجع',
      submit: 'إرسال الشكوى',
      submitAnother: 'إرسال شكوى أخرى',
      submitManualReview: 'إرسال للمراجعة اليدوية',
      retryOptions: 'إعادة تحميل الخيارات',
    ...
    states: {
      ...
      options: 'تعذر تحميل القوائم. يمكنك الإرسال الآن. سيصنف الموظفون الشكوى.',
