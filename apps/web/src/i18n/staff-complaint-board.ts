...
export const complaintBoardText = {
  en: {
    ...
    detail: {
      trigger: 'Open ticket {reference} details',
      description: 'Read-only summary — updates, SLA and ownership. Use the link below for full actions.',
      updates: 'Updates & timeline',
      loading: 'Loading updates…',
      empty: 'No updates recorded yet.',
      error: 'Updates could not be loaded. Open the full ticket to review them.',
      openFull: 'Open full ticket',
      close: 'Close details',
      meta: { status: 'Status', severity: 'Severity', sla: 'SLA', owner: 'Owner', branch: 'Branch', daysActive: 'Days active', updated: 'Last updated' },
  ...
  ar: {
    ...
    detail: {
      trigger: 'فتح تفاصيل التذكرة {reference}',
      description: 'ملخّص للقراءة فقط — التحديثات والمهلة والإسناد. استخدم الرابط أدناه للإجراءات الكاملة.',
      updates: 'التحديثات والمخطط الزمني',
      loading: 'جارٍ تحميل التحديثات…',
      empty: 'لا توجد تحديثات مسجّلة بعد.',
      error: 'تعذّر تحميل التحديثات. افتح التذكرة الكاملة لمراجعتها.',
      openFull: 'فتح التذكرة الكاملة',
      close: 'إغلاق التفاصيل',
      meta: { status: 'الحالة', severity: 'الخطورة', sla: 'المهلة', owner: 'المسؤول', branch: 'الفرع', daysActive: 'أيام النشاط', updated: 'آخر تحديث' },
