...
export const taskBoardText = {
  en: {
    ...
    detail: {
      trigger: 'Open task {title} details',
      description: 'Read-only summary — updates, assignment and due date. Use the link below for full actions.',
      updates: 'Updates',
      loading: 'Loading updates…',
      empty: 'No updates yet.',
      error: 'Updates could not be loaded. Open the full task to review them.',
      openFull: 'Open full task',
      close: 'Close details',
      meta: { status: 'Status', assignee: 'Assignee', owner: 'Owner', department: 'Department', daysActive: 'Days active', due: 'Due' },
      daysActive: { one: '1 day', other: '{count} days' },
    },
    toasts: {
  ...
  ar: {
    ...
    detail: {
      trigger: 'فتح تفاصيل المهمة {title}',
      description: 'ملخّص للقراءة فقط — التحديثات والإسناد وتاريخ الاستحقاق. استخدم الرابط أدناه للإجراءات الكاملة.',
      updates: 'التحديثات',
      loading: 'جارٍ تحميل التحديثات…',
      empty: 'لا توجد تحديثات بعد.',
      error: 'تعذّر تحميل التحديثات. افتح المهمة الكاملة لمراجعتها.',
      openFull: 'فتح المهمة الكاملة',
      close: 'إغلاق التفاصيل',
      meta: { status: 'الحالة', assignee: 'المسند إليه', owner: 'المالك', department: 'القسم', daysActive: 'أيام النشاط', due: 'الاستحقاق' },
      daysActive: { one: 'يوم واحد', other: '{count} أيام' },
    },
    toasts: {
